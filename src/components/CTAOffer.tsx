...
import { Calendar, Clock, ArrowRight, MapPin, Languages } from 'lucide-react';
          ...
          <div className="relative z-10 max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 mb-8 sm:mb-12">
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl">
                ...
                <p className="text-white/40 text-xs">07 January 2026</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl">
                <Clock className="w-6 h-6 text-accent mx-auto mb-3" />
                <p className="text-white font-bold">Time</p>
                <p className="text-white/40 text-xs">11:00 AM IST (99 Min)</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl">
                <MapPin className="w-6 h-6 text-accent mx-auto mb-3" />
                <p className="text-white font-bold">Location</p>
                <p className="text-white/40 text-xs">Masterclass Live on Zoom</p>
              </div>
              <div className="bg-white/5 backdrop-blur-md border border-white/10 p-6 rounded-2xl">
                <Languages className="w-6 h-6 text-accent mx-auto mb-3" />
                <p className="text-white font-bold">Language</p>
                <p className="text-white/40 text-xs">Hinglish</p>
              </div>
            </div>

            <div className="flex flex-col items-center gap-6">
              <div className="text-center mb-4">
                <p className="text-white/40 line-through text-lg">₹101</p>
                <p className="text-white text-5xl font-bold tracking-tighter">₹51 <span className="text-lg font-normal text-white/40">only</span></p>
              </div>
